...
MESH
----------------------------------------------------------------------------*/
#define MODEL_MESH "./models/stanford-bunny.dae"
/*----------------------------------------------------------------------------
----------------------------------------------------------------------------*/
...
{
	// Set up the shaders
	phongShaderProgram = CompileShaders(phongShaderProgram, "./shaders/phongVertexShader.txt", "./shaders/phongFragmentShader.txt");
	toonShaderProgram = CompileShaders(toonShaderProgram, "./shaders/toonVertexShader.txt", "./shaders/toonFragmentShader.txt");
	toonShaderProgram2 = CompileShaders(toonShaderProgram2, "./shaders/toonVertexShader2.txt", "./shaders/toonFragmentShader2.txt");
	cookTorranceShaderProgram = CompileShaders(cookTorranceShaderProgram, "./shaders/cookTorranceVertexShader.txt", "./shaders/cookTorranceFragmentShader.txt");
	textShaderProgram = CompileShaders(textShaderProgram, "./shaders/textVertexShader.txt", "./shaders/textFragmentShader.txt");
